...
abstract class IPictureOfTheDayRemoteDataSource {
  ...
  Future<List<PictureItemModel>> searchPicturesByDate(DateTime date);
}
...
class PictureOfTheDayRemoteDataSourceImpl extends IPictureOfTheDayRemoteDataSource {
  ...
  PictureOfTheDayRemoteDataSourceImpl({required this.dio});
  ...
  @override
  Future<List<PictureItemModel>> searchPicturesByDate(DateTime date) async {
    final response = await dio.get(
      '',
